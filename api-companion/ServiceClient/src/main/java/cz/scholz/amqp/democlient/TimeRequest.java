...
public class TimeRequest {
    private static final Logger LOGGER = LoggerFactory.getLogger(TimeRequest.class);
    ...
    public void run() throws JMSException, NamingException, InterruptedException {
        ...
        try {
            ...
            requestProducer = session.createProducer((Destination) context.lookup("time"));
    ...
    public static void main(String[] args) throws JMSException, NamingException, InterruptedException {
        TimeRequest client = new TimeRequest();
        client.run();
    }
}